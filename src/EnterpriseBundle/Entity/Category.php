...
class Category
{
     ...
     * Add children
     *
     * @param \EnterpriseBundle\Entity\Category $children
     * @return Category
     */
    public function addChild(\EnterpriseBundle\Entity\Category $children)
    {
     ...
     * @param \EnterpriseBundle\Entity\Category $children
     */
    public function removeChild(\EnterpriseBundle\Entity\Category $children)
    {
